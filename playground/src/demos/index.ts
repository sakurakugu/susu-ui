...
import ResizableDemo from './ResizableDemo.vue'
...
import VirtualTreeDemo from './VirtualTreeDemo.vue'
...
export const playgroundDemos = [
  ...
  { id: 'resizable', component: ResizableDemo },
  ...
  { id: 'virtual-tree', component: VirtualTreeDemo },
